...
class _ShowProductSellerState extends State<ShowProductSeller> {
  ...
  Future<Null> loadValueFromAPI() async {
    ...
    String apiGetProductWhereIdSeller =
        '${MyConstant.domain}/lizder/getProductWhereIdseller.php?isAdd=true&idSeller=$id';
...
String createUrl(String string) {
    ...
    String url = '${MyConstant.domain}/lizder${strings[0]}';
    return url;
  }
          ...
          TextButton(
            onPressed: () async {
              ...
              String apiDeleteProductWhereId =
                  '${MyConstant.domain}/lizder/deleteProductWhereId.php?isAdd=true&id=${productModel.id}';

...
import 'package:lizder/bodys/my_money_buyer.dart';
import 'package:lizder/bodys/my_order_buyer.dart';
import 'package:lizder/bodys/show_all_shop_buyer.dart';
...
@override
  ...
  Future<void> findUserLogin() async {
    ...
    var urlAPI =
        '${MyConstant.domain}/lizder/getUserWhereId.php?isAdd=true&id=$idUserLogin';
    await Dio().get(urlAPI).then((value) async {
      ...
      var path =
          '${MyConstant.domain}/lizder/getWalletWhereIdBuyer.php?isAdd=true&idBuyer=${userModel!.id}';

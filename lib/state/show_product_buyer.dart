...
import 'package:lizder/models/sqlite_model.dart';
...
import 'package:lizder/utility/sqlite_helper.dart';
...
class _ShowProductBuyerState extends State<ShowProductBuyer> {
 UserModel? userModel;
  ...
  Future<void> readAPI() async {
    String urlAPI =
        '${MyConstant.domain}/lizder/getProductWhereIdSeller.php?isAdd=true&idSeller=${userModel!.id}';
  ...
  String findUrlImage(String arrayImage) {
    ...
    String result = '${MyConstant.domain}/lizder${strings[0]}';
    // print('### result = $result');
    return result;
  }
                ...
                content: SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                      CachedNetworkImage(
                        imageUrl:
                            '${MyConstant.domain}/lizder${images[indexImage]}',
                        placeholder: (context, url) => ShowProgress(),
                      ),
                      Padding(
                      ...
                      TextButton(
                        onPressed: () async {
                          ...
                          if ((currentIdSeller == idSeller) ||
                            ...
                            Navigator.pop(context);
                            Navigator.pop(context);
                            MyDialog().normalDialog(context, 'Wrong Shop ?',
                                'please choose product from the shop before choose other shop');
                          }
                        },
                        child: Text(
                          'Add Cart',

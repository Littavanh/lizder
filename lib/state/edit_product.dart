        ...
        children: [
          ...
          Container(
            ...
            child: files[index] == null
                ? CachedNetworkImage(
                    imageUrl:
                        '${MyConstant.domain}/lizder/${pathImages[index]}',
  ...
  Future<Null> processEdit() async {
    if (formKey.currentState!.validate()) {
        ...
        for (var item in files) {
          if (item != null) {
            ...
            String apiUploadImage =
                '${MyConstant.domain}/lizder/saveProduct.php';
      ...
      String apiEditProduct =
          '${MyConstant.domain}/lizder/editProductWhereId.php?isAdd=true&id=$id&name=$name&price=$price&detail=$detail&images=$images';

...
UserModel? userModel;
    ...
    if (formKey.currentState!.validate()) {
      if (file == null) {
        ...
        await Dio().post(apiSaveAvatar, data: formData).then((value) {
          print('Upload Succes');
          String pathAvatar = '/lizder/avatar/$nameFile';
  ...
  Future<Null> editValueToMySQL(String pathAvatar) async {
    ...
    String apiEditProfile =
        '${MyConstant.domain}/lizder/editProfileSellerWhereId.php?isAdd=true&id=${userModel!.id}&name=${nameController.text}&address=${addressController.text}&phone=${phoneController.text}&avatar=$pathAvatar&lat=${latLng!.latitude}&lng=${latLng!.longitude}';
